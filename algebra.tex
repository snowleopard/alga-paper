...
the \hs{Arbitrary@\,\,@(Expr@\,\,\blk{a}@)} instance, where \hs{Expr}
...
For example, let's do a quick check of \hs{Expr@\,@Int} in interactive GHC:
...
\noindent
QuickCheck generates 100 random test cases $(x,y,z)$ using the \hs{gen}
