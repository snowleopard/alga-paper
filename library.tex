...
concrete \hs{Graph} instances provide a much faster equivalent of \hs{removeEdge}.
...
that it uses specialised \hs{IntMap} and \hs{IntSet} data structures and therefore
