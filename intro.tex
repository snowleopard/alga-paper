...
$E=\{(1,2), (2,3)\}$. Note that \hs{buildG} is a partial function:
...
The operations on algebraic graphs that we chose, called \emph{overlay} and \emph{connect},
...
name collision (\hs{data Graph} and \hs{class Graph}) is not a problem in practice,
