...
It represents graphs by \emph{adjacency arrays}~\cite{1995_king_graphs} whose internal
consistency invariant is not statically checked, which can lead to runtime
usage errors (\textsf{`index out of range'}). Another popular library \textsf{fgl} uses
...
In this paper we present \emph{algebraic graphs} --- a new interface for construction
and transformation of graphs (more precisely, graphs with labelled vertices and unlabelled
